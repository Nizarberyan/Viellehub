...
<head>
    ...
    <!-- Select2 CSS (optional if you're using Select2) -->
...
<!-- Sidebar -->
<aside
        class="bg-blue-900 text-white w-64 p-6 absolute md:static inset-y-0 left-0 transform transition-transform duration-300 ease-in-out z-10 md:translate-x-0"
...
<!-- JS for Modals and Interactions -->
<script>
    // Modal Interaction
